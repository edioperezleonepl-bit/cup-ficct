 ...
 * CU19 — Gestionar comprobantes y pasarela de pago
 * Módulo: P3_RequisitosYPagos
 *
 * Controla la generación de órdenes de pago con QR simulado
 * y la confirmación del pago del postulante.
 */
class PaymentController extends Controller
{
    /**
     * Genera una orden de pago con un QR simulado para el postulante.
     * Valida que el postulante haya entregado su Título de Bachiller antes de proceder.
     *
