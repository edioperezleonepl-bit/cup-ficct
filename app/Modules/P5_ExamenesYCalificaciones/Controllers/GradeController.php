 ...
 *
 * Permite registrar y consultar las calificaciones de los postulantes
 * en las materias del curso preuniversitario (3 exámenes por materia).
 */
class GradeController extends Controller
{
    ...
    public function store(Request $request): JsonResponse
    {
        ...
        try {
            return DB::transaction(function () use ($validated) {
                ...
                // Resetear estado del postulante para recalcular en el siguiente proceso
    ...
    /**
     * Obtiene las notas cargadas de un postulante específico.
     *
